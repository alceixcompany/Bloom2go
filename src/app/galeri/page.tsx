...
const GaleriPage = () => {
  ...
  return (
    <main className="page-flow min-h-screen bg-[#2a211c]">
      <section className="relative flex min-h-[450px] h-[60vh] items-center overflow-hidden">
        <div className="absolute inset-0">
          <Image
            ...
            quality={90}
          />
          <div className="absolute inset-0 bg-[#2a211c]/60 backdrop-blur-sm" />
        </div>
