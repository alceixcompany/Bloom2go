...
const ServiceAreasPage = () => {
  ...
  return (
    <div className="page-flow min-h-screen bg-[#2a211c]">
      <section className="relative py-24 text-white overflow-hidden flex items-center min-h-[450px]">
        <div className="absolute inset-0">
          <Image
            src={withAssetVersion('/about/hero.png')}
            alt="Bloom2GO Hizmet Bölgelerimiz"
            fill
            priority
            ...
            quality={85}
          />
          <div className="absolute inset-0 bg-[#2a211c]/70 backdrop-blur-sm"></div>
        </div>
