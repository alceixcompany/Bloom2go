...
const servicesData = {
  ...
  'musteri-deneyimi': {
    ...
    features: ['Kurulum modeli planlamasi', 'Lokasyona uygun otomat kurgusu', 'Markaya uyarlanabilir saha yerlesimi', 'Satis sonrasi destek sureci'],
    overview: 'Bloom2GO Otomat Satisi modeli, kendi lokasyonunda cicek otomat deneyimi kurmak isteyen is ortaklari icin operasyon ve kurulum akislarini tek butunde toplar.',
    whyChoose: ['Hazir bir modelle daha hizli ilerlersiniz', 'Kurulum ve saha kurgusu birlikte planlanir', 'Marka deneyimini Bloom2GO altyapisiyla desteklersiniz'],
    process: [
      { step: 1, title: 'Lokasyonu Degerlendirin', description: 'Kurulum dusundugunuz alanin yaya trafigi ve operasyon yapisi birlikte incelenir.' },
      { step: 2, title: 'Modeli Belirleyin', description: 'Ihtiyaca uygun Bloom2GO otomat kurgusu ve saha yerlesimi secilir.' },
      { step: 3, title: 'Kurulumu Planlayin', description: 'Elektrik, erisim, stok ve operasyon akisinin nasil ilerleyecegi netlestirilir.' },
      { step: 4, title: 'Devreye Alin', description: 'Kurulum sonrasi saha kullanimi ve destek sureci ile model aktif hale getirilir.' },
    ],
  },
} as const;
